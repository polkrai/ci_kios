	...
	<?php if(!$this->session->userdata('logged_in')) :?>
	  ...
	  <div id="login-content">
	   <?php if(isset($login_error)) : ?>
	    <div id="error" class="error-msg"><?php echo $login_error?></div>
	   <?php endif; ?>
	   <form name="frmLogin" method="post" action="/home/login">
	      <p style="margin:5px 0;"><label for="login_id" class="small-text" style="display:block;">Login ID: </label><input type="text" name="login_id" id="login_id" size="20" maxlength="20" value="<?php echo $this->validate->get_field_value('login_id')?>" /></p>
