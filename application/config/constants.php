...
defined('HOST_SOCKET')         OR define('HOST_SOCKET', $_SERVER['SERVER_NAME']); //'25.57.60.238' $_SERVER['SERVER_NAME']
defined('SOCKET_PORT')		   OR define('SOCKET_PORT', 1337);
defined('HOST_PORT_SOCKET')	   OR define('HOST_PORT_SOCKET', "http://".HOST_SOCKET.":".SOCKET_PORT);
...
define('APP_NAME', 	    basename(BASE_URI));