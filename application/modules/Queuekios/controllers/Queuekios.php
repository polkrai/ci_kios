...
class Queuekios extends CI_Controller {
    ...
    */
	...
	public function form_kios ($queuekios_id = NULL) {
		...
		//echo ">>" . $this->mdl_queuekios->run_validation();exit();
		

		if ($_GET) { //&& $this->mdl_queuekios->run_validation() //$_REQUEST && $this->input->get_post('submit')
			...
			//$emit_data = array('queuetype' => 'requestqueue', 'client_request' => $_SERVER['REMOTE_ADDR'], 'kios_id' => NULL);
