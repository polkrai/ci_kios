...
function _684(_68a){
opts.month+=_68a;
//opts.current=new Date(opts.year,opts.month,7);
if(opts.month>12){
opts.year++;
opts.month=1;
}else{
...
$.fn.calendar.defaults={width:180,height:180,fit:false,border:true,showWeek:false,firstDay:0,weeks:["อา", "จ", "อ", "พ", "พฤ", "ศ", "ส"],months:["มกราคม", "กุมภาพันธ์", "มีนาคม", "เมษายน", "พฤษภาคม", "มิถุนายน", "กรกฎาคม", "สิงหาคม", "กันยายน", "ตุลาคม", "พฤศจิกายน", "ธันวาคม"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:(function(){
var d=new Date();
...
_c61(this,q);
}},currentText:"วันนี้",closeText:"ปิด",okText:"ตกลง",buttons:[{text:function(_c76){
